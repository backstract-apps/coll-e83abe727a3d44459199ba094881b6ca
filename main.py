...
app = FastAPI(title='Backstract Generated APIs - coll-e83abe727a3d44459199ba094881b6ca', debug=False,
              docs_url='/hungry-aryabhata-45ea940ef81111ef92110242ac12000586/docs',
              openapi_url='/hungry-aryabhata-45ea940ef81111ef92110242ac12000586/openapi.json')
...
app.include_router(
    router,
    prefix='/hungry-aryabhata-45ea940ef81111ef92110242ac12000586/api',
    tags=['APIs v1']
)
